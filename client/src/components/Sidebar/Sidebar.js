            ...
            <div>
                <div className="vertical-list">
                    <MenuItem eventKey={4.1} onClick={() => {
                        ...
                        <Glyphicon glyph={this.state.CollapseKoncept ? "chevron-right" : "chevron-left"}/>
                    </MenuItem>
                    ...
                    <MenuItem eventKey={4.2} onClick={() => {
                        ...
                        <Glyphicon glyph={this.state.CollapseWidget ? "chevron-left" : "chevron-right"}/>
                    </MenuItem>
                    ...
                    <MenuItem eventKey={4.3} onClick={() => {
                        ...
                        <Glyphicon glyph={this.state.CollapseStep ? "chevron-left" : "chevron-right"}/>
                    </MenuItem>
                </div>
            </div>
        );
